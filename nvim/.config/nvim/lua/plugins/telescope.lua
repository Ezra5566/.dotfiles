...
return {
  -- super powerful fuzzy-finder
  {
    ...
    cmd = "Telescope",
    keys = {
      { "<leader>fgf", find_files_or_git_files, mode = "n", desc = "Find Files or Git Files" },
